...
最終更新: 2026-09-13（**Phase 3 に入った**。`P3-01`（Ontop VKG）が完了し、**実データを実体化せずに SPARQL で引ける**ようになった。残るデプロイ窓は `P2A-21` と `P3-07` である）
...
Phase 3 で完了したもの: `P3-01`（Ontop VKG。**宛先を間違えると 0 件が返ることを実測したので、宛先を URL で分けた**）。
