...
最終更新: 2026-09-13（**デプロイ窓の実機確認を完了した**。`P2A-09` / `P2A-18` / `P2A-19` / `P2A-02` の 9 項目すべて通り、`azd down --purge` まで済んでいる。**残るのは Web UI**（`P2A-03` / `P2A-04`）だけである）
...
| `P2A-03` | Web でのレビュー・承認フロー | **見た目と操作の設計（人の好み）。** ADR で決めるより実物を見て決めるほうが早い |
| `P2A-04` | グラフ可視化（Cytoscape.js 等） | 同上 |
