...
| **Phase 2** | Scan/Model + 運用 | AI がオントロジーを作れる **かつ** 運用し続けられる | **柱 B は完了。柱 A は Web UI（`P2A-03` / `P2A-04`）を残して実装・実機確認とも完了** |
...
- Web でのレビュー・承認フロー（グラフ可視化を含む）— **見た目と操作の設計が中心。** ADR で決めるより実物を見て決めるほうが早い
